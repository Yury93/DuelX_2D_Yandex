...
namespace SpaceShooter
{
    ...
    public class Destructible : Entity
    {
        ...
        protected virtual void Start()
        {
            ...
            if(isPlayerShip)
            onCheckHp?.Invoke(m_CurrentHitPoints);
            if (HitPointBar) HitPointBar.Init(this.transform, m_CurrentHitPoints);
        }
        #endregion
        ...
        public void ApplyDamage(int damage)
        {
            ...
            if (isPlayerShip && m_CurrentHitPoints >= 0)
                onCheckHp?.Invoke(m_CurrentHitPoints);
            ...
            if (HitPointBar) HitPointBar.Set(m_CurrentHitPoints);
        }
        #endregion
      ...
      //  }
        ...
        public void SetIndestructibleObject(bool destrOrNoDestr)
        {
