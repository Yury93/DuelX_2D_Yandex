       ...
       private Rigidbody2D m_Rigid;
        ...
        private void FixedUpdate()
        {
            ...
            if (m_TimerForProperties <= 1 )
            {
                ...
                SetIndestructibleObject(m_Gods);
        ...
        private void OnCollisionEnter2D(Collision2D collision)
        {
            ...
            var enivromentShip = collision.gameObject.GetComponent<EnivromentShip>();
            var otherDestructible = collision.gameObject.GetComponent<Destructible>();
            ...
            if(otherDestructible && !enivromentShip && !ship && !projectile)
            {
                ApplyDamage(1);
            }
        }
